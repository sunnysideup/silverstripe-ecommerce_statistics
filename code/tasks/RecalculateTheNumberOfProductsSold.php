...
class RecalculateTheNumberOfProductsSold extends BuildTask
{
    ...
    protected static $number_sold_calculation_type = "SUM"; //SUM or COUNT
        public static function set_number_sold_calculation_type($s)
        {
            self::$number_sold_calculation_type = $s;
        }
    public static function get_number_sold_calculation_type()
    {
        return self::$number_sold_calculation_type;
    }
